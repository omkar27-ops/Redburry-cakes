      ...
      <div className="relative py-24 bg-secondary">
        <div className="max-w-[800px] mx-auto px-6 text-center">
          ...
          <p className="text-lg text-text-secondary leading-relaxed">
            Red Bury Cakes began with a simple philosophy: a cake should be as memorable as the moment it celebrates.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
          <div className="order-2 md:order-1 h-[600px] bg-white rounded-2xl shadow-xl border border-gray-100 p-4">
            <div className="w-full h-full rounded-xl bg-secondary border-2 border-dashed border-primary/20 flex flex-col items-center justify-center text-center p-8">
                 <span className="text-primary/30 font-serif font-bold text-2xl uppercase tracking-widest mb-4">Our Kitchen</span>
                 <span className="text-text-tertiary font-medium">Baker Placeholder</span>
            </div>
          </div>
          <div className="order-1 md:order-2 space-y-6">
            ...
            <p className="text-text-secondary leading-loose">
              Founded in 2010 in the heart of the city, Red Bury Cakes was born from a passion for refined aesthetics and uncompromising flavor. We don't just bake; we sculpt, we design, and we pour our hearts into every layer.
            </p>
            <p className="text-text-secondary leading-loose">
