    ...
    <>
          ...
          <div className="relative h-[500px] md:h-[600px] w-full hidden md:block">
            ...
            <div className="absolute top-0 right-0 w-64 h-80 bg-white p-2 shadow-card rounded-2xl rotate-[3deg] z-20 hover:scale-105 transition-transform duration-500 border border-primary/10">
              <div className="w-full h-full rounded-xl flex items-center justify-center bg-white border-2 border-dashed border-primary/30 text-primary/40 font-bold uppercase tracking-widest text-xs relative overflow-hidden">
                 Cake Photo
                 <div className="absolute bottom-2 left-0 right-0 text-center text-[10px] font-bold text-primary/60 uppercase tracking-widest">Wedding</div>
              </div>
            </div>
            ...
            <div className="absolute top-1/4 left-1/4 w-48 h-48 bg-white p-2 shadow-card rounded-2xl rotate-[-2deg] z-30 hover:scale-105 transition-transform duration-500 border border-primary/10">
              <div className="w-full h-full rounded-xl flex items-center justify-center bg-white border-2 border-dashed border-primary/30 text-primary/40 font-bold uppercase tracking-widest text-xs">
                 Cake Photo
              </div>
            </div>
            ...
            <div className="absolute top-[-20px] left-[40%] w-32 h-32 bg-white p-2 shadow-card rounded-xl rotate-[5deg] z-10 hover:scale-105 transition-transform duration-500 border border-primary/10">
               <div className="w-full h-full rounded-lg flex items-center justify-center bg-white border-2 border-dashed border-primary/30 text-primary/40 font-bold uppercase tracking-widest text-xs">
                 Cake Photo
              </div>
            </div>
            ...
            <div className="absolute top-20 right-[30%] w-24 h-24 bg-white p-1.5 shadow-sm rounded-lg rotate-[12deg] z-0 opacity-80 border border-primary/10">
               <div className="w-full h-full rounded-md flex items-center justify-center bg-white border-2 border-dashed border-primary/30 text-primary/40 font-bold uppercase tracking-widest text-[10px]">
                 Photo
              </div>
            </div>
          </div>
      ...
      <section className="bg-secondary py-20 lg:py-32">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { id: 1, name: "Velvet Rose Royale", price: "$85", desc: "Red velvet sponge, mascarpone cream, fresh berries." },
              { id: 2, name: "Midnight Truffle", price: "$95", desc: "Dark Belgian chocolate, gold dust, truffle ganache." },
              { id: 3, name: "Vanilla Bean Dream", price: "$75", desc: "Madagascan vanilla, swiss buttercream, white orchids." }
            ].map((cake) => (
              <div key={cake.id} className="group bg-white rounded-2xl p-4 transition-all duration-300 hover:-translate-y-2 hover:shadow-glow border border-transparent hover:border-primary/10">
                <div className="aspect-square rounded-xl overflow-hidden mb-6 flex items-center justify-center bg-secondary border-2 border-dashed border-primary/20">
                  <span className="text-primary/40 font-serif font-bold uppercase tracking-widest">Cake Photo</span>
                </div>
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[500px] group bg-white border border-gray-100 p-4">
             <div className="w-full h-full rounded-xl flex items-center justify-center bg-secondary border-2 border-dashed border-primary/20">
               <span className="text-primary/40 font-serif font-bold uppercase tracking-widest text-xl">Custom Cake Photo</span>
             </div>
             <div className="absolute bottom-8 left-8 right-8">
              <span className="text-text font-serif text-2xl tracking-wide bg-white/80 backdrop-blur-sm px-4 py-2 rounded-lg inline-block">Handcrafted Masterpieces</span>
            </div>
          </div>
      ...
      <section className="bg-white py-20 border-t border-gray-50 overflow-hidden">
        ...
        <div className="flex overflow-x-auto gap-6 pb-12 px-6 md:px-[calc((100vw-1200px)/2)] no-scrollbar snap-x">
          {[
            { name: "Sarah & James", event: "Wedding", quote: "The most stunning cake we've ever seen. It tasted like heaven!" },
            { name: "Emily Blunt", event: "30th Birthday", quote: "Red Bury Cakes nailed the design perfectly. Everyone asked where it was from." },
            { name: "TechCorp Inc.", event: "Corporate Gala", quote: "Professional service and a dessert that impressed our VIP clients." },
            { name: "Jessica M.", event: "Baby Shower", quote: "Elegant, not too sweet, and absolutely beautiful packaging." },
          ].map((item, idx) => (
      ...
      <section className="bg-primary py-24 text-center px-6">
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <p className="text-white/80 text-lg">
            Book your consultation today and let's create something magical.
          </p>
