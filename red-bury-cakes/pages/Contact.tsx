              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-secondary">123 Baker Street, Luxury Lane<br />Beverly Hills, CA 90210</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-secondary">hello@redburycakes.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-text-secondary">
                <div className="flex justify-between border-b border-gray-100 pb-2">
                  ...
                  <span className="font-medium text-text">9:00 AM - 7:00 PM</span>
                </div>
                <div className="flex justify-between border-b border-gray-100 pb-2">
                  <span>Saturday</span>
                  <span className="font-medium text-text">10:00 AM - 6:00 PM</span>
                </div>
