    ...
    >
      <div className="max-w-[1200px] mx-auto px-6 h-full flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          <img src="/images/logo.jpg" alt="Redburry Cakes Logo" className="h-10 w-auto" />
          <span className="text-2xl font-bold text-primary font-serif">Redburry</span>
          <span className="text-2xl font-normal text-text font-serif group-hover:text-primary transition-colors">Cakes</span>
        </Link>
